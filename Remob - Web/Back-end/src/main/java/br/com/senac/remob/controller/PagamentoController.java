...
public class PagamentoController {
    ...
    public ResponseEntity<?> excluirPagamentos(@PathVariable int id) {

        Optional<Pagamento> excluirPagamentos = pagamentoRepository.findById(id);
        Pagamento Pa = null;

        if (excluirPagamentos.isPresent()) {
            Pa = excluirPagamentos.get();

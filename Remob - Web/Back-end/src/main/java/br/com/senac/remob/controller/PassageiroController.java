...
public class PassageiroController {
    ...
    public ResponseEntity<?> atualizarPassageiros(@PathVariable int id,
        ...
        if (atualizarPassageiros.isPresent()) {
            ...
            P.setNascimento(entity.getNascimento());
            P.setTelefone(entity.getTelefone());
            P.setEmail(entity.getEmail());
            P.setSenha(entity.getSenha());
            P.setGenero(entity.getGenero());
            P.setAvaliacoesMedia(entity.getAvaliacoesMedia());
            P.setTotalAvaliacoes(entity.getTotalAvaliacoes());
            P.setPne(entity.getPne());
    ...
    public ResponseEntity<?> excluirPassageiros(@PathVariable int id) {

        Optional<Passageiro> excluirPassageiros = passageiroRepository.findById(id);
        Passageiro P = null;

        if (excluirPassageiros.isPresent()) {
            P = excluirPassageiros.get();
